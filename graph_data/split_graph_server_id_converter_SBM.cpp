...
int main() {
    ...
    {
        edges[src/10000].push_back(Edge_dstIp(src, dst, dst/10000));
        // edges[dst/10000].push_back(Edge_dstIp(dst, src, src/10000));
    }
    fclose(in_f);
    ...
    for (int i = 0; i < split_num; i++) {
        ...
        string output_path = "./SBM_3/" + to_string(split_num) + "/" + server_id[i] + ".data";
    ...
    read_graph("./SBM_3/3/10.58.60.6.data", read_edges, read_e_num);
