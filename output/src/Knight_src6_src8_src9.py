...
src6_list = []
for i in range(6):
    src6_list.append('../src6_' + RW_num + '_RTT_' + str(20 * i) + '_loss_' + loss + '.txt')

src8_list = []
for i in range(6):
    src8_list.append('../src8_' + RW_num + '_RTT_' + str(20 * i) + '_loss_' + loss + '.txt')

src9_list = []
for i in range(6):
    src9_list.append('../src9_' + RW_num + '_RTT_' + str(20 * i) + '_loss_' + loss + '.txt')
...
ax1.plot(x, y2, label='KnightKing')
