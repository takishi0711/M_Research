...
f_AR_300_list.append('../data/' + 'AR_300' + '_' + 'SBM_5' + '_' + str(walker_num_per_vertex) + "_RTT_" + '100' + '_loss_' + '0.03' + '.txt')
...
f_AR_300_list.append('../data/' + 'AR_300' + '_' + 'SBM_3' + '_' + str(walker_num_per_vertex) + "_RTT_" + '100' + '_loss_' + '0.03' + '.txt')
...
f_AR_300_list.append('../data/' + 'AR_300' + '_' + 'SBM_6' + '_' + str(walker_num_per_vertex) + "_RTT_" + '100' + '_loss_' + '0.03' + '.txt')
...
f_AR_300_list.append('../data/' + 'AR_300' + '_' + 'SBM_4' + '_' + str(walker_num_per_vertex) + "_RTT_" + '100' + '_loss_' + '0.03' + '.txt')
...
f_AR_300_list.append('../data/' + 'AR_300' + '_' + 'SBM_7' + '_' + str(walker_num_per_vertex) + "_RTT_" + '100' + '_loss_' + '0.03' + '.txt')
...
for i in range(5):
    ...
    data_AR_300_list.append(np.loadtxt(f_AR_300_list[i], unpack=True))
...
data = [y_Kn_list, y_AR_list, y_AR_200_list, y_AR_300_list, y_AR_400_list]
...
# 棒グラフをプロット
name = ['KnightKing', 'Proposed Method (normal)', 'origin + reuse = 2,000,000', 'origin + reuse = 3,000,000', 'origin + reuse = 4,000,000']
